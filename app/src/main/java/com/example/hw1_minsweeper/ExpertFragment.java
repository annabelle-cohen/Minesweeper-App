...
public class ExpertFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      //  return inflater.inflate(R.layout.fragment_expert, container, false);
        ...
        View view =  lf.inflate(R.layout.fragment_expert, container, false);
        TextView text = (TextView)view.findViewById(R.id.screen_show_bottom);
        mySharedPref sharedPref=new mySharedPref(getActivity());
        String first_score= sharedPref.getString("Expert_Score_1","");
        String second_score = sharedPref.getString("Expert_Score_2","");
        String third_score = sharedPref.getString("Expert_Score_3","");
        text.setText("\n1."+first_score+"\n"+"2."+second_score+"\n"+"3."+third_score+"\n");
        return  view;
    }
}
